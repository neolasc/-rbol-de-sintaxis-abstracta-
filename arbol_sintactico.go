...
func evaluarArbol(t *Arbol) bool {
if tipoExpresion(t.izq.valor) == "operador operacion: " && tipoExpresion(t.der.valor) == "operador operacion: "  {
     return true
    }
  return false
}
func cal (t *Arbol) int{
  return calcular(t.izq)
}
...
var (
expresionesConstantes = []string{"[a-z0-28]"}
)

var (
expresionesVariables = []string{"[a-z]"}
)
